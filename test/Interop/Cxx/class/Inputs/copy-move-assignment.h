...
//     __attribute__((optnone))
//     NonTrivialCopyAndCopyMoveAssign(const NonTrivialCopyAndCopyMoveAssign
//     &other) : assignCounter(other.assignCounter),
//     instanceBalancer(other.instanceBalancer) {
//         someFunc();
//     }
//     __attribute__((optnone))
//     NonTrivialCopyAndCopyMoveAssign( NonTrivialCopyAndCopyMoveAssign &&other)
//     : assignCounter(other.assignCounter),
//     instanceBalancer(other.instanceBalancer) {
//         someFunc();
//     }
//     __attribute__((optnone))
...
//     __attribute__((optnone))
//     NonTrivialCopyAndCopyMoveAssign &operator =(const
//     NonTrivialCopyAndCopyMoveAssign &) {
//         ++assignCounter;
//         return *this;
//     }
//     __attribute__((optnone))
//     NonTrivialCopyAndCopyMoveAssign &operator
//     =(NonTrivialCopyAndCopyMoveAssign &&) {
//         ++assignCounter;
//         return *this;
//     }
...
public:
  T *element;
  CxxStruct(const CxxStruct &) = default;
  CxxStruct(CxxStruct &&) = default;
};

using NonCopyableVector = std::vector<NonCopyable>;
using NonCopyableCxxStruct = CxxStruct<NonCopyable>;
