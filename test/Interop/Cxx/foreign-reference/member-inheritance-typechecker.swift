...
func callsOverridesOfRenamedVirtualMethods(
  _ a1: A1, _ a2: A2, _ b1: B1, _ c1: C1, _ c2: C2, _ d1: D1, _ d2: D2, _ d3: D3, _ d4: D4
) {
  a1.virtualMethod()
  ...
  c2.virtualMethod()
  c2.swiftVirtualMethod()  // expected-error {{'swiftVirtualMethod()' is unavailable: ignoring swift_name 'swiftVirtualMethod()' in 'C2'; swift_name attributes have no effect in virtual methods overrides}}
  ...
  c2.swiftBarRename()
  c2.B1BarRename()  // expected-error {{'B1BarRename()' is unavailable: ignoring swift_name 'B1BarRename()' in 'C2'; swift_name attributes have no effect in virtual methods overrides}}
  c2.paramsRename(42)  // expected-error {{value of type 'C2' has no member 'paramsRename'}}
  c2.swiftParamsRename(a1: 42)
  c2.swiftParamsRename(b1: 42)  // expected-error {{'swiftParamsRename(b1:)' is unavailable: ignoring swift_name 'swiftParamsRename(b1:)' in 'C2'; swift_name attributes have no effect in virtual methods overrides}}
  ...
  d2.swiftParamsRename(b1: 42)  // expected-error {{'swiftParamsRename(b1:)' is unavailable: ignoring swift_name 'swiftParamsRename(b1:)' in 'B1'; swift_name attributes have no effect in virtual methods overrides}}

  d3.virtualMethod()
  d3.swiftVirtualMethod()  // expected-error {{'swiftVirtualMethod()' is unavailable: ignoring swift_name 'swiftVirtualMethod()' in 'B1'; swift_name attributes have no effect in virtual methods overrides}}
  ...
  d3.swiftBarRename()
  d3.B1BarRename()  // expected-error {{'B1BarRename()' is unavailable: ignoring swift_name 'B1BarRename()' in 'B1'; swift_name attributes have no effect in virtual methods overrides}}
  d3.swiftParamsRename(a1: 42)
  d3.swiftParamsRename(b1: 42)  // expected-error {{'swiftParamsRename(b1:)' is unavailable: ignoring swift_name 'swiftParamsRename(b1:)' in 'B1'; swift_name attributes have no effect in virtual methods overrides}}

  d4.virtualMethod()
  d4.swiftVirtualMethod()  // expected-error {{'swiftVirtualMethod()' is unavailable: ignoring swift_name 'swiftVirtualMethod()' in 'B1'; swift_name attributes have no effect in virtual methods overrides}}
  ...
  d4.swiftBarRename()
  d4.B1BarRename()  // expected-error {{'B1BarRename()' is unavailable: ignoring swift_name 'B1BarRename()' in 'B1'; swift_name attributes have no effect in virtual methods overrides}}
