// RUN: %target-run-simple-swift(-g -I %S/Inputs -cxx-interoperability-mode=default -Xfrontend -disable-availability-checking)
//
...
if #available(SwiftStdlib 5.8, *) {
  FunctionsTestSuite.test("renamed C++ virtual method") {
    ...
    func overrides(_ a1: A1, _ b1: B1, _ c1: C1, _ c2: C2, _ a2: A2, _ d1: D1, _ d2: D2) {
      ...
      // expectEqual(d1.swiftFooRename(), 112); --> TODO check ambiguous
      ...
      // expectEqual(d2.swiftFooRename(), 122); --> TODO check ambiguous
    }
  } 
}
